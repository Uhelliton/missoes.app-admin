<template>
  <b-col md="12" lg="8">
    <b-card no-body>
      ...
      <b-card-body class="pt-0" v-if="chartConfig">
        <ApexChart
          :chart="chartConfig"
          class="apex-charts"
...
import type { ISummaryEvangelismDaily} from "@/modules/dashaboard/types/bi-evangelism.interface";
import { useChart } from "@/modules/dashaboard/composables/useChart";
